...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.abspath(os.path.join(ROOT_PATH,'../animar.db')),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'q1zqop55qm!@9)t16q(88pe(vi+-3$^$ns-a189$y0hy)8&@6d'
